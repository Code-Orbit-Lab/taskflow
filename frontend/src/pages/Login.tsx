  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-ink px-6">
      ...
      >
        ...
        <p className="text-sm text-paper-dim mb-8">Sign in to pick up where your team left off.</p>
        ...
        <p className="mt-6 text-center text-sm text-paper-dim">
          New to TaskFlow?{" "}
          <Link to="/register" className="text-flow hover:text-flow-dim font-medium">
            Create an account
          </Link>
        </p>
      </motion.div>
